...
var Ja,Fa,Ka,za,Ha,S,Ia,dynCall_vii,dynCall_vi,dynCall_iii,dynCall_v,Da,ra,Ca,Ea,J,La={d:function(){return Ga(async()=>{await new Promise(function(a){if("function"===typeof setImmediate&&"object"===typeof process&&process.versions&&process.versions.node)setImmediate(a);else if("function"===typeof MessageChannel){var b=f.$yieldChannel;b||(b=f.$yieldChannel=new MessageChannel,b.port1.onmessage=function(){var c=f.$yieldResolve;f.$yieldResolve=null;c&&c()});f.$yieldResolve=a;b.port2.postMessage(0)}else setTimeout(a,
...
Z=await (async function(){function a(c){var d=Z=c.exports;c={};for(let [e,g]of Object.entries(d))"function"==typeof g?(d=qa(g),c[e]=d):c[e]=g;c=Z=c;Ja=f._main=c.u;Fa=c.v;f._chessiro_command=c.w;Ka=c.x;za=c.y;Ha=c.z;S=c.A;Ia=c.B;dynCall_vii=c.D;dynCall_vi=c.G;dynCall_iii=c.H;dynCall_v=c.L;Da=c.X;ra=c.Y;Ca=c.Z;Ea=c._;J=c.s;fa();return Z}var b={a:La};if(f.instantiateWasm)return new Promise(c=>{f.instantiateWasm(b,(d,e)=>{c(a(d,e))})});L??=f.locateFile?f.locateFile("sf19-st-nosimd.wasm",w):
w+"sf19-st-nosimd.wasm";return a((await ja(b)).instance)}());(function(a=r){f.calledRun=!0;E||(ea=!0,Z.t(),F?.(f),Ma(a))})();ea?moduleRtn=f:moduleRtn=new Promise((a,b)=>{F=a;ba=b});
